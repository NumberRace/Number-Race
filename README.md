  ...
  <tbody>
    <tr>
      <td align="center" valign="top">
        ...
        <sub>$${\textsf{Developer of this game}}$$</sub><br />
        <sub>$${\textsf{and Website (not done), Artist}}$$</sub>
      </td>
      <td align="center" valign="top">
        ...
        <sub>$${\textsf{Developer of}}$$</sub><br />
        <sub>$${\textsf{Termux Android}}$$</sub>
      </td>
      <td align="center" valign="top">
        ...
        <sub>$${\textsf{Developer of Python}}$$</sub><br />
        <sub>$${\textsf{Programming Language}}$$</sub>
    </tr>
  </tbody>
</table>
